...
colorscheme.common = {
    ...
    -- TabLine        = { fg = colors.white,   bg = colors.none   },
    ...
    DiffChange     = { fg = colors.green,   bg = colors.none   },
    DiffDelete     = { fg = colors.red,     bg = colors.none   },
    DiffText       = { fg = colors.red,     bg = colors.none   },
    Directory      = { fg = colors.green,   bg = colors.none   },
    EndOfBuffer    = { fg = colors.gray_1,  bg = colors.none   },
    FoldColumn     = { fg = colors.gray_3,  bg = colors.none   },
    Folded         = { fg = colors.gray_3,  bg = colors.none   },
...
for key, value in pairs(colorscheme) do
    for name, settings in pairs(value) do
