...
colorscheme.lsp                 = {
    ...
    LspSignatureActiveParameter = { bg = colors.none, fg = colors.white },
...
colorscheme.treesitter              = {
    ...
    ["@label"]                      = { link = "Label" },
    ["@markup"]                     = { bg = colors.none, fg = colors.white },
    ["@markup.heading"]             = { bg = colors.none, fg = colors.white },
    ["@markup.italic"]              = { bg = colors.none, fg = colors.white },
    ["@markup.link"]                = { bg = colors.none, fg = colors.white },
    ["@markup.strikethrough"]       = { bg = colors.none, fg = colors.white },
    ["@markup.strong"]              = { bg = colors.none, fg = colors.white },
    ["@markup.underline"]           = { bg = colors.none, fg = colors.white },
...
apply(colorscheme.diagnostic)
apply(colorscheme.interface)
apply(colorscheme.syntax)
apply(colorscheme.netrw)
apply(colorscheme.plain)

if vim.fn.has("nvim-0.8") == 1 then
    apply(colorscheme.lsp)
    apply(colorscheme.treesitter)
end
